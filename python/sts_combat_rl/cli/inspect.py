...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--row", type=int, default=None, help="Specific row index to inspect (default: all)")
    parser.add_argument("--limit", type=int, default=None, help="Maximum number of rows to print")
    parser.add_argument("--indent", type=int, default=2, help="JSON indentation")
    args = parser.parse_args(argv)

    print(parquet_to_json(args.parquet_path, row_index=args.row, limit=args.limit, indent=args.indent))
